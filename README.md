...
ای‌پی‌آی وردپرس دروازه ارتباطی بین سایت Next.js شما و محتوای وردپرس است. شما با ارسال درخواست به آدرس‌های مشخص (که به آنها Endpoint می‌گوییم)، اطلاعات را دریافت یا ارسال می‌کنید.
...
به زبان ساده، مرورگرها یک سیاست امنیتی دارند که اجازه نمی‌دهد یک سایت (`your-frontend.com`) به راحتی از یک سایت دیگر (`api.yourdomain.com`) داده درخواست کند، مگر اینکه سایت دوم صراحتاً اجازه داده باشد.
